...
<title>Car Ngar Mal | Vehicle Details</title>
<!--Bootstrap -->
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true"></i>Booking</h5>
          </div>
          <form method="post">
            ...
            <div class="text">
              <p>*Online Payment Methods are available in your profile tab</p>
            </div>
