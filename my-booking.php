...
<title>Car Ngar Mal | My Bookings</title>
<!--Bootstrap -->
...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>From Date:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>To Date:</b> <?php echo htmlentities($result->ToDate);?><br />
                   <b>Price Per Day: $</b><?php echo htmlentities($result->PricePerDay);?><br>
                   <b>Cost: $</b><?php echo htmlentities($days* $result->PricePerDay);?>
                </p>
